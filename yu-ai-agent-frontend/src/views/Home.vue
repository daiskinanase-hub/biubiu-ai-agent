  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">BIUBIU~AI超级智能体</h1>
      </div>
    ...
    <div class="apps-container">
      ...
      <div class="app-card" @click="navigateTo('/knowledge-base')">
        ...
        <div class="app-info">
          <div class="app-title">知识库检索</div>
          <div class="app-desc">上传PDF文档，智能检索问答</div>
        </div>
        <div class="app-button">
          <span class="btn-text">立即体验</span>
          <span class="btn-icon">→</span>
...
// 设置页面标题和元数据
useHead({
  title: 'BIUBIU~AI超级智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: 'BIUBIU~AI超级智能体应用平台提供AI恋爱大师、AI超级智能体和知识库检索服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI恋爱大师,AI助手,智能对话,知识库检索,鱼皮,AI超级智能体,首页'
    }
  ]
})
